...
import {  ChevronLeft, ChevronDown, Crop, Info, Pencil, Trash2, Wand2, Image, Ban, PencilRuler, ScissorsSquareDashedBottom, RectangleHorizontal, Square, RectangleVertical, Loader2, Copy, Star, History, Replace } from 'lucide-react';
...
import Container from '@/components/media/container';
...
const MediaViewer = ({ resource }: { resource: CloudinaryResource }) => {
  ...
  return (
    <div className="h-screen bg-black px-0">
      ...
      <Container className="fixed z-10 top-32 md:top-24 left-0 w-full h-16 flex items-center justify-between gap-4 bg-gradient-to-b from-black">
